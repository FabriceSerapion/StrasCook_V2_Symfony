...
class Menu
{
    ...
    #[ORM\Column(
        type: Types::FLOAT)]
    #[Assert\NotBlank(
        message: 'Le prix du menu est nécessaire !')]
    // #[Assert\Type(
    //     message: 'Veuillez entre un nombre. Séparez les décimales par un point.')
    // ]
    ...
    public function getTagsArea(): ?string
    {
        return $this->tagsArea;
    }

    public function setTagsArea(?string $tagsArea): self
    {
